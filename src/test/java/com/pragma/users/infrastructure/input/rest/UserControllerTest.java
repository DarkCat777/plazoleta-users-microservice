...
class UserControllerTest {
    ...
    void shouldCreateOwnerSuccessfully() throws Exception {
        CreateUserCommand request = new CreateUserCommand("John", "Doe", "12345678", "987654321",
    ...
    void shouldReturn409WhenOwnerAlreadyExists() throws Exception {
        ...
        when(userService.createOwner(request))
        ...
        mockMvc.perform(post(BASE_URL + "/owner")
                ...
                .andExpect(jsonPath("$.message").value("Ya existe un usuario registrado con el correo: john@example.com"));
    }

    @Test
    @WithMockUser(roles = "ADMINISTRATOR")
    void shouldReturn400WhenValidationRuleFails() throws Exception {
